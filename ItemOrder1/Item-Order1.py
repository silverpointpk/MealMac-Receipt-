...
draw.text((width // 2 - 55, y + 5), "Item 1 / 3", font=font_bold, fill="white")
y += bar_height + 30
...
y += 30
draw.text((width // 2, y), "Mayo, Satay", font=font_regular, fill="black", anchor="mm")
y += 40


# Save the image
image.save("ItemOrder1.png")
#Show the image
image.show()